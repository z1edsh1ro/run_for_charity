...
function ProfileReponsible() {
  ...
  const changeRole = (idAgency) => {
    window.location = "/changerole/"+idAgency
  }
          ...
          <div className={styles.containner}>
            ...
            <div className={styles.main}>
              ...
              <div className={styles.field}>
                <h5>Permission :</h5>
                <h>{user.role}</h>
                <div className={styles.btnFream}>
                  <Button className={styles.btnPermission} onClick={() => changeRole(agency.idAgency)}>ขอเป็นผู้รับผิดชอบหน่วยงาน</Button>
                </div>
              </div>
              <div class="frame">
                <Button
...
export default ProfileReponsible;
